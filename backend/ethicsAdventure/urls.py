...
urlpatterns = [
    ...
    path('api/gameSession/answer/', GameSessionAnswerViewSet.as_view({'put': 'record_answer', 'patch': 'record_answer'}), name='record_answer'),
    path('api/gameSession/passcode/', GameSessionAnswerViewSet.as_view({'post':'create'}), name='enter_passcode'),
