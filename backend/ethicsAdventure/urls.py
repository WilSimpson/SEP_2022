...
urlpatterns = [
    ...
    path('api/gameSession/answer/<int:game_session_answer_id>', GameSessionAnswerViewSet.as_view({'put': 'record_answer', 'patch': 'record_answer'}), name='record_answer'),
    path('api/gameSession/passcodeAnswer/', GameSessionAnswerViewSet.as_view({'post':'create'}), name='enter_passcode'),
